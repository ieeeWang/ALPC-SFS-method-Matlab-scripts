function y = awgn1(varargin)
% this is a copy from the MATLAB with installed commulacation system
% toolbox. and the name has been changed (+1) to avoid the system errer.
