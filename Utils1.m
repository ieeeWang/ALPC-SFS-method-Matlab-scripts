...
function [min_mse, tao_est, pltOut] = apprent_latency_cycles(f_output, yy, alfa_in, fs, plt, t_stimuli)
...
function [min_mse, tao_est, pltOut] = apprent_latency_cycles_angle(f_output, angle_f_out, alfa_in, plt, t_compens, tmax)
